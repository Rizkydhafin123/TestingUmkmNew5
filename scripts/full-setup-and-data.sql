-- 1. Enable UUID extension (jika belum ada)
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- 2. Hapus tabel yang sudah ada jika ada, untuk memastikan clean slate
...
-- 5. Buat indeks untuk performa yang lebih baik
...
-- 6. Masukkan user admin default dan data UMKM contoh
