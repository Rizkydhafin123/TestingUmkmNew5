...
-- Hapus data lama sebelum insert ulang (opsional, jika ingin bersih)
DELETE FROM umkm;
DELETE FROM users;
...
ON CONFLICT (id) DO NOTHING; -- Gunakan ON CONFLICT (id) DO NOTHING untuk menghindari duplikasi jika script dijalankan ulang
